...
# personality's GOT reference. (ld64 classic named each CIE EH_Frame1
# and each FDE func.eh and wrote the fields as SUBTRACTOR pairs.)
otool -l $t/merged.o | grep -A8 'sectname __eh_frame' | grep -q 'flags 0x6800000b'
